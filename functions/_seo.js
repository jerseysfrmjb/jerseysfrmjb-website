...
<head>
  ...
  <link rel="stylesheet" href="/styles.css?v=card-links-1"><link rel="stylesheet" href="/design-preview.css?v=mobile-grid-2">
  <script src="/meta-pixel.js?v=1" defer></script><script src="/analytics.js?v=1" defer></script><script src="/storefront.js?v=card-links-1" defer></script>
</head>
